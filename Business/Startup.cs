...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IOlanaklarRepository, OlanaklarRepository>();
            services.AddTransient<IOdaOlanakRepository, OdaOlanakRepository>();
            services.AddTransient<IOdaEkServiceRepository, OdaEkServiceRepository>();
            services.AddTransient<IIletisimRepository, IletisimRepository>();
            services.AddTransient<IGirisRepository, GirisRepository>();
            services.AddTransient<IGalaryBlogRepository, GalaryBlogRepository>();
            services.AddTransient<IGalaryRepository, GalaryRepository>();
            services.AddTransient<IEvDetailRepository, EvDetailRepository>();
            services.AddTransient<IEvRepository, EvRepository>();
